...
**NOTE:PLEASE USE THIS PROGRAM WHEN NO OTHER PROGRAM IS RUNNING!**
...
Lastly, run the **cleanbycrast.sh** file as root by typing ```sudo bash cleanbycrast```and you are good to go.

Thank you for choosing **CleanByCrast** as your log cleaner!

**Türkçe:**

**NOT:LÜTFEN BU PROGRAMI BAŞKA HİÇBİR PROGRAM ÇALIŞMIYORKEN KULLANIN!**
...
Son olarak **cleanbycrast.sh** dosyasını ```sudo bash cleanbycrast```yazarak root olarak çalıştırın ve artık hazırsınız.
